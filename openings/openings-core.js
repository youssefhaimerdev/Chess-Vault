...
},,
{
  ...
  subtitle:'Paul Morphy (White) vs Duke of Brunswick & Count Isouard — Paris, 1858',
  white:'Paul Morphy', black:'Duke of Brunswick & Count Isouard',
  result:'1-0',
  moves:['e2e4','e7e5','g1f3','d7d6','d2d4','c8g4','d4e5','g4f3',
  ...
  notes:[
    "1.e4 — Morphy opens with the king's pawn.",
    "1...e5 — Symmetrical reply.",
    "2.Nf3 — Development, attacks e5.",
    "2...d6 — The Philidor Defence.",
    "3.d4 — Strikes in the centre!",
    "3...Bg4? — Premature pin.",
    "4.dxe5 — Morphy grabs the pawn!",
    "4...Bxf3 — Black takes the knight.",
    "5.Qxf3 — Recaptures, gaining open position and bishop pair.",
    "5...dxe5 — Black takes back.",
    "6.Bc4 — Development! Eyes the vulnerable f7.",
    "6...Nf6 — Black develops.",
    "7.Qb3 — DOUBLE THREAT! Attacks f7 and b7 simultaneously.",
    "7...Qe7 — Defending f7.",
    "8.Nc3 — Development with tempo.",
    "8...c6 — Defends b5.",
    "9.Bg5 — Another piece with tempo, pins the knight.",
    "9...b5? — Black opens up the position.",
    "10.Nxb5!! — THE SACRIFICE! Knight given for a crushing attack.",
    "10...cxb5 — Black accepts.",
    "11.Bxb5+ — Check! The bishop swoops in.",
    "11...Nbd7 — Blocks the check.",
    "12.O-O-O — CASTLES QUEENSIDE! Rooks connect for the attack.",
    "12...Rd8 — Black defends d7.",
    "13.Rxd7!! — EXCHANGE SACRIFICE! The rook tears through.",
    "13...Rxd7 — Black must take.",
    "14.Rd1 — Second rook joins with decisive effect.",
    "14...Qe6 — Black tries to defend.",
    "15.Bxd7+ — Bishop captures with check!",
    "15...Nxd7 — Black captures.",
    "16.Qb8+!! — THE QUEEN SACRIFICE! Morphy gives his queen away.",
    "16...Nxb8 — Black must accept.",
    "17.Rd8# — CHECKMATE! A masterpiece of development and sacrifice."
  ]
},
{
  ...
  notes:[
    ...
    "18.Bd6!! — THE KEY SACRIFICE! Bishop given away.",
    "18...Bxg1 — Black takes the rook!",
    "19.e5 — White advances.",
    ...
    "23.Be7# — CHECKMATE! White mated while down two rooks and a bishop."
  ]
}
